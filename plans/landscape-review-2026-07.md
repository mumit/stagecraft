...
| [32](phase-32-performance-parallelism.md) | Performance: cache-first prompts, stage DAG waves, model-tier routing, best-of-N | 28 (telemetry) | L | ⚠️ 32.1/32.2/32.3/32.5/32.6 shipped — **ADR-017 accepted and implemented 2026-08-05** (PR #401); **32.4 deferred** |
...
Remaining work: revisit 32.4 if a host adapter ever exposes worktree-isolated dispatch. Open items are tracked in [README.md](README.md#what-is-not-delivered-yet).
