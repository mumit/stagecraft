...
Five documents. If you read only these, you can decide whether to adopt Stagecraft and run
your first pipeline.
...
and the rest — is real and (per [docs/README.md](README.md)) indexed, but none of it is required
reading to get started. Go there once one of these five points you at it.

Changing Stagecraft itself rather than using it? [CONTRIBUTING.md](../CONTRIBUTING.md) is your
front door instead — [README.md](../README.md#documentation-map)'s "Contributor" path lists
the five docs for that job.
