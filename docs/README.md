...
- [adr/017-dag-wave-execution.md](adr/017-dag-wave-execution.md) — accepted curated `dependsOn[]` metadata, wave formation bounded by `autonomy.max_parallel_stages`, chain stays track-order
