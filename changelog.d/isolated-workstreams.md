...
- Clarify that feature artifact isolation (`pipeline.isolation`) and coding-agent checkout isolation are independent controls, and record the core-managed reconciliation contract in ADR-018.
